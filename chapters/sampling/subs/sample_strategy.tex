...
\label{sec:sample_strategy}
	...
	\label{sec:improving_the_sampled_capacity_margin}
		...
		\todo{capacity margin is currently defined later in the thesis. Move
		that discussion up}
		\todo{Above speaking about normal distribution. That is for the graph.
		Uniform distribution is used for normal samples}
