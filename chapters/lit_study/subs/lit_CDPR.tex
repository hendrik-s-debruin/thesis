...
\label{sec:modelling_of_cable_driven_parallel_robots}
    ...
    \label{sec:geometric_model}
        ...
        \label{sec:direct_geometric_model}
			...
			controller \todo{cite page 139} and is not directly required in path
			planning, an overview of the algorithms for calculating
			$\geometricmodel$ is outside the scope of this literature study. The
			algorithms may be found in\todo{cite page
			154}.
	...
	\label{sec:dynamic_model}
		...
		The dynamic model is then defined as \todo{cite p 254}:
		...
		for high speed robots, but may be neglected for slower speeds\todo{ref p
		254}.
		...
		here. More details on these effects may be found in\todo{ref p 255}.
    ...
    \label{sec:the_workspace_of_a_cdpr}
        ...
        \label{sec:common_workspace_subsets}
            ...
            \label{sec:workspace_aspect}
				...
				aspects   remains	an	 open	 problem\todo{cite	  p    165}.
		...
		\label{sec:workspace_representation}
			...
			methods are mentioned below\todo{cite p 182}.
		...
		\label{sec:criteria_on_poses_in_the_workspace}
			...
			\label{sec:cable_cable_interference_and_cable_platform_interference}
				...
				collected here, but references may be found in\todo{ref page 188
				and bookref there}.
		...
		\label{sec:determining_the_workspace}
			...
			\label{sec:continuous_workspace_determination}
				...
				Algorithm~\ref{alg:interval_csp_solver}.\todo{ref page 198}
