...
\label{sec:path_planning}
	...
	\label{sec:continuous_case}
		...
		\label{sec:combinatorial_motion_planning}
			...
			\begin{figure}[hb]
				\missingfigure{Example 2D Cell Decomposition}
			...
			It should be noted that \todo{reference here} warns that
			...
			good reference for such algorithms can be found in \todo{reference}.
