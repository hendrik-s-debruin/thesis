...
\label{sec:motion_law_generation_algorithm}
	...
	linear interpolation of the control points\todo{wording}. A steeper slope
	...
	\todo{in this entire section, $x$ and $B$ not in nomenclature}
	...
	$\set{X}$\todo{not in nomenclature} that spans the domain $x$ of $B$ with
	...
	\end{equation}
	\todo{$\set{T}$ is not in nomenclature here}
